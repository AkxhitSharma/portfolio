...
const messages = ref([
  { role: "assistant", content: "Hi, Let me assist you with Akshit's Resume" },
  { role: "assistant", content: "You can ask me anything you would like to know about his potfolio." },
])
